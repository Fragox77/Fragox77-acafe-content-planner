  ...
  return (
    <div className="animate-fade-in">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-2xl font-bold text-amber-900">Seguimiento de Métricas</h3>
        <button
          onClick={onAdd}
      ...
      <div className="overflow-x-auto rounded-lg border">
        <table className="w-full text-sm text-left text-gray-500">
          ...
          <tbody>
            {data.map((row, idx) => (
              <tr key={row.id} className={`${idx % 2 === 0 ? 'bg-white' : 'bg-blue-50'} border-b`}>
                ...
                <td className="px-4 py-3 font-bold text-blue-900">{calculateEngagement(row)}</td>
